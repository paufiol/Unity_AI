...
namespace Complete
{
    public class TankWander : MonoBehaviour
    {
        ...
        private void FixedUpdate()
        {
            ...
            m_Rigidbody.rotation = Quaternion.Slerp(transform.rotation, m_Rigidbody.rotation, m_TurnSpeed);
            m_Rigidbody.position += transform.forward.normalized * m_Speed;
        ...
        private void Wander()
        {
            ...
            Vector3 localTarget = new Vector3(Random.Range(-1.0f, 1.0f), Random.Range(-1.0f, 1.0f), localTarget.Normalize());
